<?php
namespace My\Mod\Block\Adminhtml\Task\Edit;
...
class Form extends Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $model = $this->_coreRegistry->registry('mod_task');
        ...
        $fieldset->addField(
            'description',
            'textarea',
            ['name' => 'description', 'label' => __('Task Description'), 'title' => __('Task Description'), 'required' => true]
        );
